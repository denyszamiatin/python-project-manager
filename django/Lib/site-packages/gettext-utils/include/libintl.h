...
#endif
extern LIBINTL_DLL_EXPORTED char *gettext _INTL_PARAMS ((const char *__msgid))
...
#endif
extern LIBINTL_DLL_EXPORTED char *dgettext _INTL_PARAMS ((const char *__domainname,
				     const char *__msgid))
...
#endif
extern LIBINTL_DLL_EXPORTED char *dcgettext _INTL_PARAMS ((const char *__domainname,
				      const char *__msgid,
				      int __category))
...
#endif
extern LIBINTL_DLL_EXPORTED char *ngettext _INTL_PARAMS ((const char *__msgid1,
				     const char *__msgid2,
				     unsigned long int __n))
...
#endif
extern LIBINTL_DLL_EXPORTED char *dngettext _INTL_PARAMS ((const char *__domainname,
				      const char *__msgid1,
				      const char *__msgid2,
				      unsigned long int __n))
...
#endif
extern LIBINTL_DLL_EXPORTED char *dcngettext _INTL_PARAMS ((const char *__domainname,
				       const char *__msgid1,
				       const char *__msgid2,
				       unsigned long int __n,
				       int __category))
...
#endif
extern LIBINTL_DLL_EXPORTED char *textdomain _INTL_PARAMS ((const char *__domainname))
...
#endif
extern LIBINTL_DLL_EXPORTED char *bindtextdomain _INTL_PARAMS ((const char *__domainname,
					   const char *__dirname))
...
#endif
extern LIBINTL_DLL_EXPORTED char *bind_textdomain_codeset _INTL_PARAMS ((const char *__domainname,
						    const char *__codeset))
